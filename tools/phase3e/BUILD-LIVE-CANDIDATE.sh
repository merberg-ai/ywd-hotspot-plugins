...
# The final signed package intentionally exposes only the standard declared
# ui.js/ui.css files. The decoder and live-audio source are concatenated into
# ui.js below, so Plugin UI v1 requires no extra asset privilege.
PY
